...
import type { LocationPoint as _LocationPoint, SOSEvent as _SOSEvent, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addAudioToEvent(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAudioToEvent(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createSOSEvent(arg0: string): Promise<{
        id: string;
        shareToken: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.createSOSEvent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveLocations(arg0: string): Promise<Array<LocationPoint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveLocations(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEvent(arg0: string): Promise<SOSEvent> {
        if (this.processError) {
            try {
                const result = await this.actor.getEvent(arg0);
                return from_candid_SOSEvent_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getLocations(arg0: string): Promise<Array<LocationPoint>> {
        if (this.processError) {
            try {
    ...
    async stopEvent(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.stopEvent(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLocation(arg0: string, arg1: string, arg2: LocationPoint): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_SOSEvent_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SOSEvent): SOSEvent {
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    audioBlobIds: Array<string>;
    isActive: boolean;
    locationHistory: Array<_LocationPoint>;
    emergencyMessage: string;
}): {
    id: string;
    startTime: bigint;
    ...
    return {
        ...
        audioBlobIds: value.audioBlobIds,
        isActive: value.isActive,
        locationHistory: value.locationHistory,
        emergencyMessage: value.emergencyMessage
    };
}
...
function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SOSEvent>): Array<SOSEvent> {
    return value.map((x)=>from_candid_SOSEvent_n12(_uploadFile, _downloadFile, x));
}
